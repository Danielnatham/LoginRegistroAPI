...
import one.digitalinnovation.one.loginAPI.appuser.AppUser;
import one.digitalinnovation.one.loginAPI.appuser.AppUserRole;
import one.digitalinnovation.one.loginAPI.appuser.AppUserService;
import one.digitalinnovation.one.loginAPI.email.EmailSender;
...
public class RegistrationService {
    ...
    public String confirmToken(String token) {
        ...
        if (confirmationToken.getConfirmedAt () != null) {
            throw new IllegalStateException ( "Email ja confirmado" );
        }
